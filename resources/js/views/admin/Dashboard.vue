<template>
  <div class="container">
    <PageHeader title="Dashboard Admin" subtitle="Widget-uri: comenzi, top clienți, top produse, blocaje credit etc.">
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        <p class="text-muted">
          Aceasta este o pagină de template pentru <strong>Dashboard Admin</strong>.
