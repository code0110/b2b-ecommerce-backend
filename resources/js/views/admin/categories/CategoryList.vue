<template>
  <div class="container">
    <PageHeader title="Categorii - listă" subtitle="Listă de categorii, reordonare, publicare/ascundere.">
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        <p class="text-muted">
          Aceasta este o pagină de template pentru <strong>Categorii - listă</strong>.
